...
public class RestauranteController {
    ...
    @ApiResponses(value = { 
    		  @ApiResponse(responseCode = "200", description = "Retorna uma lista de Restaurantes", 
    ...
    @Operation(summary = "Faz uma busca pelos restaurantes")
    @ApiResponses(value = { 
    		  @ApiResponse(responseCode = "200", description = "Realiza uma busca de restaurantes pelo ID", 
    		    content = { @Content(mediaType = "application/json", 
    		            array = @ArraySchema(schema = @Schema(implementation = Restaurante.class))) })
    })
    @GetMapping("/{id}")
    ...
    @Operation(summary = "Atualiza os restaurantes")
    @ApiResponses(value = { 
    		  @ApiResponse(responseCode = "200", description = "Atualiza os restaurantes cadastrados", 
    		    content = { @Content(mediaType = "application/json", 
    		            array = @ArraySchema(schema = @Schema(implementation = Restaurante.class))) })
    })
    @PutMapping("/{id}")
    ...
    @ApiResponses(value = { 
    		  @ApiResponse(responseCode = "204", description = "Deleta um restaurante pelo ID", 
    		    content = { @Content(mediaType = "application/json", 
    		            array = @ArraySchema(schema = @Schema(implementation = Restaurante.class))) })
    })
    @DeleteMapping("/{id}")
    ...
    @Operation(summary = "Busca Restaurante pelo Nome")
    @ApiResponses(value = { 
    		  @ApiResponse(responseCode = "200", description = "Busca Restaurante pelo Nome", 
    		    content = { @Content(mediaType = "application/json", 
    		            array = @ArraySchema(schema = @Schema(implementation = Restaurante.class))) })
    })
    ...
    @Operation(summary = "Busca Restaurante pelo Endereco")
    @ApiResponses(value = { 
    		  @ApiResponse(responseCode = "200", description = "Busca Restaurante pelo Endereco", 
    		    content = { @Content(mediaType = "application/json", 
    		            array = @ArraySchema(schema = @Schema(implementation = Restaurante.class))) })
    })
    ...
    @Operation(summary = "Busca Restaurante pelo Tipo de Cozinha")
    @ApiResponses(value = { 
    		  @ApiResponse(responseCode = "200", description = "Busca Restaurante pelo Tipo de Cozinha", 
    		    content = { @Content(mediaType = "application/json", 
    		            array = @ArraySchema(schema = @Schema(implementation = Restaurante.class))) })
    })
